    ...
    window.currentEmailQueue.forEach((item, index) => {
        ...
        <div class="bg-white border border-gray-200 p-3 rounded-lg shadow-sm hover:shadow-md transition flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 group">
            ...
            <div class="flex gap-2 w-full sm:w-auto">
                <a href="${waLink}" target="_blank" onclick="if(this.href !== '#') { markAsSent(this); window.markUserAlerted('${item.email}', window.currentEmailQueue[${index}].dutyKeys, 'wa'); }" class= px-3 py-1.5 rounded text-xs font-bold shadow-sm flex items-center justify-center gap-1 flex-1 sm:flex-none transition border">
